...
#if NET7_0
    , BigRational.Float<UInt64>.IFloat<Float64>
#endif
  {    
    ...
    public static Float64 Parse(ReadOnlySpan<char> s, IFormatProvider? provider = null) => new Float64(BigRational.Float<UInt64>.Parse(s, provider));
    /// <inheritdoc cref="ISpanParsable{TSelf}.TryParse(ReadOnlySpan{char}, IFormatProvider?, out TSelf)" />
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out Float64 result) { var t = BigRational.Float<UInt64>.TryParse(s, provider, out var r); result = new Float64(r); return t; }
    ...
    public static Float64 Abs(Float64 a) => new Float64(BigRational.Float<UInt64>.Abs(a.p));
    public static Float64 Sqrt(Float64 a) => new Float64(BigRational.Float<UInt64>.Sqrt(a.p));
    public static Float64 Sin(Float64 a) => new Float64(BigRational.Float<UInt64>.Sin(a.p));
    public static Float64 Truncate(Float64 x) => new Float64(BigRational.Float<UInt64>.Truncate(x.p));
    
    public static Float64 Pi => new Float64(BigRational.Float<UInt64>.Pi);
    public static Float64 Tau => new Float64(BigRational.Float<UInt64>.Tau);
    public static Float64 E => new Float64(BigRational.Float<UInt64>.E);
...
#if NET7_0
    , BigRational.Float<Float96.UInt96>.IFloat<Float96>
#endif
  {
    public readonly override string ToString() => p.ToString();
    public readonly string ToString(string? format, IFormatProvider? provider = default) => p.ToString(format, provider);
    ...
    public readonly int CompareTo(object? p) => p == null ? 1 : p is Float96 b ? BigRational.Float<UInt96>.Compare(this.p, b.p) : throw new ArgumentException();
    ...
    public static Float96 Pi => new Float96(BigRational.Float<UInt96>.Pi);
    public static Float96 Tau => new Float96(BigRational.Float<UInt96>.Pi);
    public static Float96 E => new Float96(BigRational.Float<UInt96>.E);
